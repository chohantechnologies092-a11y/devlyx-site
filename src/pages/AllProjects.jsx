    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                ...
                const portfolioItems = data.filter(p => p.entryType !== 'product');
                            ...
                            {totalPages > 1 && (
                                <div className="flex justify-center items-center gap-2">
                                    <button 
                                        ...
                                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${currentPage === 1 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white border border-gray-200 text-gray-900 hover:bg-gray-50'}`}
                                    >
                                    ...
                                    {Array.from({ length: totalPages }).map((_, idx) => (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all ${currentPage === idx + 1 ? 'bg-[#6a35ff] text-white shadow-md shadow-purple-500/30' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-50'}`}
                                        >
                                            {idx + 1}
                                        </button>
                                    ))}
                                    ...
                                    <button 
                                        ...
                                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${currentPage === totalPages ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white border border-gray-200 text-gray-900 hover:bg-gray-50'}`}
                                    >
