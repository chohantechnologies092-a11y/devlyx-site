                 ...
                 <div className="lg:col-span-5 space-y-16">
                    ...
                    <div className="pt-10 border-t border-gray-200">
                       ...
                       <div className="flex gap-4">
                          ...
                          <a href="https://www.youtube.com/@Devlyxsolutions" target="_blank" rel="noreferrer" className="w-16 h-16 rounded-3xl bg-white border border-gray-100 flex items-center justify-center text-[#FF0000] hover:bg-[#FF0000] hover:text-white transition-all duration-500 shadow-sm">
                             <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                          </a>
                          <a href="https://www.tiktok.com/@devlyxsolutions" target="_blank" rel="noreferrer" className="w-16 h-16 rounded-3xl bg-white border border-gray-100 flex items-center justify-center text-[#010101] hover:bg-[#010101] hover:text-white transition-all duration-500 shadow-sm">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                 ...
                                 <div className="relative group z-20">
                                    <div 
                                        ...
                                        className={`w-full bg-transparent border-b-2 py-4 text-xl font-black text-gray-900 outline-none cursor-pointer transition-all flex justify-between items-center ${isDropdownOpen ? 'border-[#6a35ff]' : 'border-gray-200 hover:border-gray-300'}`}
                                    >
